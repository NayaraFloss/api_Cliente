...
public partial class ClientesContext : DbContext //herda, tem classe pai
{
    ...
    {
        optionsBuilder.UseNpgsql("Host=localhost;Database=api_clientes;Username=postgres;Password=masterkey");
    }
